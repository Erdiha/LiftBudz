...
import { updateUser } from '@/redux/actions/updateCurrentUserData';
...
function Profile() {
  ...
  return (
    <>
      <div className="m-auto max-w-7xl  pb-4  flex flex-col justify-center h-screen items-center bg-blue-gray-900 ">
        ...
        <Card className="-mt-16 mb-6 lg:mx-4  max-w-5xl mx-auto w-[95%] h-full  backdrop-blur-md bg-white/80 ">
